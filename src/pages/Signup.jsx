            ...
            {/* <img src="../assets/logo.png" alt="KFUPM Connect Logo" className="mx-auto w-32 mb-4" /> */}
                ...
                <form className="space-y-4">
                    <div>
                        ...
                        <input type="text" placeholder="John Doe" className="w-full border border-gray-300 rounded-md p-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-300 outline-none" />
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">KFUPM Email</label>
                        <input type="email" placeholder="your.name@kfupm.edu.sa" className="w-full border border-gray-300 rounded-md p-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-300 outline-none" />
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Student/Staff ID</label>
                        <input type="text" placeholder="S12345678" className="w-full border border-gray-300 rounded-md p-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-300 outline-none" />
                    </div>
                    ...
                    <div>
                        ...
                        <select className="w-full border border-gray-300 rounded-md p-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-300 outline-none">
